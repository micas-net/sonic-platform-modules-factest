    ...
    "others": [
        {
            ...
            "device": [
                ...
                {"id": "eeprom_7", "name": "wb_24c02", "bus": 193, "loc": 0x52, "attr": "eeprom"},
                {"id": "eeprom_8", "name": "wb_24c02", "bus": 194, "loc": 0x54, "attr": "eeprom"},
                {"id": "eeprom_9", "name": "wb_24c02", "bus": 262, "loc": 0x56, "attr": "eeprom"},
            ],
        },
        {
            "name": "tmp275",
            "device": [
                ...
                {"id": "tmp275_2", "name": "wb_tmp275", "bus": 248, "loc": 0x48, "attr": "hwmon"},
        ...
        },
        {
            ...
            "device": [
                ...
                {"id": "ina3221_12", "name": "wb_ina3221", "bus": 216, "loc": 0x40, "attr": "hwmon"},
                {"id": "ina3221_13", "name": "wb_ina3221", "bus": 217, "loc": 0x40, "attr": "hwmon"},
            ],
        },
        {
            "name": "xdpe12284",
            "device": [
                ...
                {"id": "xdpe12284_3", "name": "wb_xdpe12284", "bus": 211, "loc": 0x58, "attr": "hwmon"},
                {"id": "xdpe12284_4", "name": "wb_xdpe12284", "bus": 212, "loc": 0x58, "attr": "hwmon"},
                {"id": "xdpe12284_5", "name": "wb_xdpe12284", "bus": 218, "loc": 0x58, "attr": "hwmon"},
            ],
        },
        {
            "name": "xdpe132g5c",
            "device": [
                {"id": "xdpe132g5c_1", "name": "wb_xdpe132g5c_pmbus", "bus": 208, "loc": 0x40, "attr": "hwmon"},
                {"id": "xdpe132g5c_2", "name": "wb_xdpe132g5c_pmbus", "bus": 209, "loc": 0x40, "attr": "hwmon"},
                {"id": "xdpe132g5c_3", "name": "wb_xdpe132g5c_pmbus", "bus": 210, "loc": 0x40, "attr": "hwmon"},
            ],
        },
...
MAC_DEFAULT_PARAM = [
    {
        ...
        "cpld_avs": {"bus": 232, "loc": 0x30, "offset": 0x10, "gettype": "i2c"},
        "set_avs": {
            "loc": "/sys/bus/i2c/devices/208-0040/hwmon/hwmon*/avs0_vout",
...
DRIVERLISTS = [
    ...
    {"name": "platform_common dfd_my_type=0x40da", "delay": 0},
...
DEVICE = [
    ...
    {"name": "wb_24c02", "bus": 193, "loc": 0x52},
    {"name": "wb_24c02", "bus": 194, "loc": 0x54},
    {"name": "wb_24c02", "bus": 262, "loc": 0x56},

    {"name": "wb_tmp275", "bus": 244, "loc": 0x48},
    {"name": "wb_tmp275", "bus": 248, "loc": 0x48},
    ...
    {"name": "wb_ina3221", "bus": 216, "loc": 0x40},
    {"name": "wb_ina3221", "bus": 217, "loc": 0x40},

    {"name": "wb_xdpe12284", "bus": 185, "loc": 0x67},
    {"name": "wb_xdpe12284", "bus": 185, "loc": 0x6c},
    {"name": "wb_xdpe12284", "bus": 211, "loc": 0x58},
    {"name": "wb_xdpe12284", "bus": 212, "loc": 0x58},
    {"name": "wb_xdpe12284", "bus": 218, "loc": 0x58},
    ...
    {"name": "wb_xdpe132g5c_pmbus", "bus": 208, "loc": 0x40},
    {"name": "wb_xdpe132g5c_pmbus", "bus": 209, "loc": 0x40},
    {"name": "wb_xdpe132g5c_pmbus", "bus": 210, "loc": 0x40},

    {"name": "wb_xdpe132g5c", "bus": 208, "loc": 0x10},
    {"name": "wb_xdpe132g5c", "bus": 209, "loc": 0x10},
    {"name": "wb_xdpe132g5c", "bus": 210, "loc": 0x10},
]

OPTOE = [
    {"name": "wb_optoe3", "startbus": 25, "endbus": 152},
    {"name": "wb_optoe2", "startbus": 158, "endbus": 159},
]
...
INIT_PARAM_PRE = [
    ...
    # set avs threshold
    # MAC_CORE_V
    {"loc": "208-0040/hwmon/hwmon*/avs0_vout_min", "value": "747000"},
    {"loc": "208-0040/hwmon/hwmon*/avs0_vout_max", "value": "840200"},
]
    ...
    "slot0": {
        ...
        "TEST": {
            ...
            "cpld": [
                ...
                {"chain": 3, "file": "/etc/.upgrade_test/fcb_cpld_test_header.vme", "display_name": "FCB_CPLD"},
                {"chain": 4, "file": "/etc/.upgrade_test/lc_cpld_test_header.vme", "display_name": "LC_CPLD"},
                #{"chain": 5, "file": "/etc/.upgrade_test/pcie_cpld_test_header.vme", "display_name": "PCIe_CPLD"},
                {"chain": 6, "file": "/etc/.upgrade_test/mac_cpldb_test_header.vme", "display_name": "MAC_CPLDB"},
                {"chain": 7, "file": "/etc/.upgrade_test/mac_cplda_test_header.vme", "display_name": "MAC_CPLDA"},
                {"chain": 8, "file": "/etc/.upgrade_test/misc_cpld_test_header.vme", "display_name": "MISC_CPLD"},
            ],
        },
    },
}
