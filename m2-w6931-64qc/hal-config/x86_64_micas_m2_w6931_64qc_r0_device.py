    ...
    "fans": [
        {
            ...
            "led": {"loc": "/dev/cpld9", "offset":0xd0, "len": 1,  "way":"devfile"},
            "led_attrs": {
                "green": 0x04, "red": 0x02, "amber": 0x06, "default": 0x04,
            ...
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {"loc": "/dev/cpld9", "offset":0x90, "len": 1,  "way":"devfile"},
        ...
        },
        {
            ...
            "SpeedMin": threshold.FAN_SPEED_MIN,
            "SpeedMax": threshold.FRONT_FAN_SPEED_MAX,
            "led": {"loc": "/dev/cpld9", "offset":0xd1, "len": 1,  "way":"devfile"},
            "led_attrs": {
                "green": 0x04, "red": 0x02, "amber": 0x06, "default": 0x04,
                "flash": 0xff, "light": 0xff, "off": 0xff, "mask": 0x07
            },
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {"loc": "/dev/cpld9", "offset":0x91, "len": 1,  "way":"devfile"},
        ...
        },
        {
            ...
            "SpeedMin": threshold.FAN_SPEED_MIN,
            "SpeedMax": threshold.FRONT_FAN_SPEED_MAX,
            "led": {"loc": "/dev/cpld9", "offset":0xd2, "len": 1,  "way":"devfile"},
            "led_attrs": {
                "green": 0x04, "red": 0x02, "amber": 0x06, "default": 0x04,
                "flash": 0xff, "light": 0xff, "off": 0xff, "mask": 0x07
            },
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {"loc": "/dev/cpld9", "offset":0x92, "len": 1,  "way":"devfile"},
        ...
        },
        {
            ...
            "SpeedMin": threshold.FAN_SPEED_MIN,
            "SpeedMax": threshold.FRONT_FAN_SPEED_MAX,
            "led": {"loc": "/dev/cpld9", "offset":0xd3, "len": 1,  "way":"devfile"},
            "led_attrs": {
                "green": 0x04, "red": 0x02, "amber": 0x06, "default": 0x04,
                "flash": 0xff, "light": 0xff, "off": 0xff, "mask": 0x07
            },
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {"loc": "/dev/cpld9", "offset":0x93, "len": 1,  "way":"devfile"},
