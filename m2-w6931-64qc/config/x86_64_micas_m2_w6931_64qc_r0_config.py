...
DEV_MONITOR_PARAM = {
    ...
    "fans": [
        {
            "name": "fan1",
            "present": {"gettype": "devfile", "path": "/dev/cpld9", "offset": 0x5b, "read_len":1, "presentbit": 0, "okval": 0},
            "device": [
        ...
        {
            "name": "fan2",
            "present": {"gettype": "devfile", "path": "/dev/cpld9", "offset": 0x5b, "read_len":1, "presentbit": 1, "okval": 0},
            "device": [
        ...
        {
            "name": "fan3",
            "present": {"gettype": "devfile", "path": "/dev/cpld9", "offset": 0x5b, "read_len":1, "presentbit": 2, "okval": 0},
            "device": [
        ...
        {
            "name": "fan4",
            "present": {"gettype": "devfile", "path": "/dev/cpld9", "offset": 0x5b, "read_len":1, "presentbit": 3, "okval": 0},
            "device": [
    ...
    "others": [
        ...
        },
        {
            ...
            "device": [
                ...
                {"id": "lm75_3", "name": "wb_lm75", "bus": 67, "loc": 0x4b, "attr": "hwmon"},
                {"id": "lm75_4", "name": "wb_lm75", "bus": 68, "loc": 0x4b, "attr": "hwmon"},
                {"id": "lm75_5", "name": "wb_lm75", "bus": 71, "loc": 0x4f, "attr": "hwmon"},
                {"id": "lm75_6", "name": "wb_lm75", "bus": 72, "loc": 0x4f, "attr": "hwmon"},
            ],
        },
        {
            "name": "ucd90160",
            "device": [
                {"id": "wb_ucd90160_1", "name": "wb_ucd90160", "bus": 60, "loc": 0x5b, "attr": "hwmon"},
                {"id": "wb_ucd90160_2", "name": "wb_ucd90160", "bus": 61, "loc": 0x5f, "attr": "hwmon"},
                {"id": "wb_ucd90160_3", "name": "wb_ucd90160", "bus": 74, "loc": 0x5b, "attr": "hwmon"},
            ],
        },
        {
            "name": "ucd9081",
            "device": [
                {"id": "wb_ucd9081_1", "name": "wb_ucd9081", "bus": 64, "loc": 0x68, "attr": "hwmon"},
            ],
        },
        {
            "name": "xdpe12284",
            "device": [
                {"id": "xdpe12284_1", "name": "wb_xdpe12284", "bus": 82, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_2", "name": "wb_xdpe12284", "bus": 83, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_3", "name": "wb_xdpe12284", "bus": 84, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_4", "name": "wb_xdpe12284", "bus": 85, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_5", "name": "wb_xdpe12284", "bus": 86, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_6", "name": "wb_xdpe12284", "bus": 87, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_7", "name": "wb_xdpe12284", "bus": 88, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_8", "name": "wb_xdpe12284", "bus": 89, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_9", "name": "wb_xdpe12284", "bus": 61, "loc": 0x70, "attr": "hwmon"},
                {"id": "xdpe12284_10", "name": "wb_xdpe12284", "bus": 61, "loc": 0x6e, "attr": "hwmon"},
                {"id": "xdpe12284_11", "name": "wb_xdpe12284", "bus": 61, "loc": 0x5e, "attr": "hwmon"},
                {"id": "xdpe12284_12", "name": "wb_xdpe12284", "bus": 61, "loc": 0x68, "attr": "hwmon"},
                {"id": "xdpe12284_13", "name": "wb_xdpe12284", "bus": 77, "loc": 0x58, "attr": "hwmon"},
            ],
        },
    ],
}
...
MAC_DEFAULT_PARAM = [
    {
        ...
        "set_avs": {
            "loc": "/sys/bus/i2c/devices/76-0040/avs0_vout_command", "gettype": "sysfs", "formula": None},
        "mac_avs_param": {
            0x8e: 0xCE2,
            0x8a: 0xD48,
            0x86: 0xDAA,
...
DRIVERLISTS = [
    ...
    {"name": "platform_common dfd_my_type=0x40d8", "delay": 0},
...
DEVICE = [
    ...
    {"name": "wb_lm75", "bus": 67, "loc": 0x4b},
    {"name": "wb_lm75", "bus": 68, "loc": 0x4b},
    {"name": "wb_lm75", "bus": 71, "loc": 0x4f},
    {"name": "wb_lm75", "bus": 72, "loc": 0x4f},
    #dcdc
    {"name": "wb_ucd90160", "bus": 60, "loc": 0x5b},
    {"name": "wb_ucd90160", "bus": 61, "loc": 0x5f},
    {"name": "wb_xdpe12284", "bus": 61, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 61, "loc": 0x6e},
    {"name": "wb_xdpe12284", "bus": 61, "loc": 0x5e},
    {"name": "wb_xdpe12284", "bus": 61, "loc": 0x68},
    {"name": "wb_ucd9081", "bus": 64, "loc": 0x68},
    {"name": "wb_ucd90160", "bus": 74, "loc": 0x5b},
    {"name": "wb_xdpe12284", "bus": 82, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 83, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 84, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 85, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 86, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 87, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 88, "loc": 0x70},
    {"name": "wb_xdpe12284", "bus": 89, "loc": 0x70},
    #avs
    {"name": "wb_xdpe132g5c_pmbus", "bus": 76, "loc": 0x40},
    {"name": "wb_xdpe132g5c", "bus": 76, "loc": 0x10},
    {"name": "wb_xdpe12284", "bus": 77, "loc": 0x58},
]

OPTOE = [
    {"name": "wb_optoe3", "startbus": 98, "endbus": 161},
    {"name": "wb_optoe2", "startbus": 162, "endbus": 163},
]
