...
static firmware_upgrade_device_t firmware_upgrade_device_data1 = {
    ...
    .en_logic_dev[4]     = "/dev/cpld8",
    .en_logic_addr[4]    = 0x49,
    .en_logic_mask[4]    = 0x00,
    .en_logic_en_val[4]  = 0x01,
    .en_logic_dis_val[4] = 0x00,
    .en_logic_width[4]   = 0x1,

    .en_logic_dev[5]     = "/dev/cpld8",
    .en_logic_addr[5]    = 0x4a,
    .en_logic_mask[5]    = 0x00,
    .en_logic_en_val[5]  = 0x01,
    .en_logic_dis_val[5] = 0x00,
