...
monitor = {
    ...
    "fancontrol_para": {
        ...
        "psu_absent_fullspeed_num": 1,   # absent psu num to let fans full speed rotate
        "fan_absent_fullspeed_num": 1,   # absentfan num to let fans full speed rotate
        "rotor_error_fullspeed_num": 1,  # broken rotor to let fans full speed rotate
        "psu_fan_control": 1,            # enable psu fan control
        "temp_warning_countdown": 15,    # beyond warning temp,  fans full speed time: 5min
        "temp_critical_countdown": 15,   # beyond critical temp, fans full speed time: 5min
    },
