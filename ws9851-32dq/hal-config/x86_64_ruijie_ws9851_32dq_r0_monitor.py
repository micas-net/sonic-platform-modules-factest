...
monitor = {
    ...
    "fancontrol_para": {
        ...
        "deal_all_fan_error_method_flag": 1,  # 处理所有风扇异常flag
        "all_fan_error_switch_temp_critical_temp": 95,  # 所有风扇异常时交换芯片过温温度为95度
        "all_fan_error_recover_log": "Power off base and mac board.",  # 所有风扇异常时交换芯片过温后的保护输出log
        "all_fan_error_recover_cmd": "dfd_debug io_wr 0x947 0xfa",  # 所有风扇异常时交换芯片过温后的保护命令
    ...
    "ledcontrol_para": {
        ...
        "psu_air_flow_yellow_num": 1,
        "fan_air_flow_yellow_num": 1,
    },
