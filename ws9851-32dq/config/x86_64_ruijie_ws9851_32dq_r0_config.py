        ...
        "func": {
            ...
            "params" : {
                "before": [
                    ...
                    {"dealtype": "shell", "cmd": "modprobe rg_spi_gpio"},
                    {"dealtype": "shell", "cmd": "modprobe rg_spi_gpio_device sck=139 miso=88 mosi=89 bus=0"},
                    {"dealtype": "shell", "cmd": "modprobe rg_spi_93xx46 spi_bus_num=0 spi_cs_gpio=87"},
                ],
                ...
                "finally": [
                    {"dealtype": "shell", "cmd": "rmmod rg_spi_93xx46"},
                    {"dealtype": "shell", "cmd": "rmmod rg_spi_gpio_device"},
                    {"dealtype": "shell", "cmd": "rmmod rg_spi_gpio"},
...
MAC_DEFAULT_PARAM = [
    {
        ...
        "cpld_avs": {"gettype": "devfile", "path": "/dev/cpld3", "offset": 0x3f, "read_len": 1},
        "set_avs": {
            "loc": "/sys/bus/i2c/devices/30-0040/hwmon/hwmon*/avs0_vout",
...
DRIVERLISTS = [
    ...
    {"name": "wb_i2c_i801 p2sb_is_hide=0", "delay": 0},
    {"name": "i2c_dev", "delay": 0},
    {"name": "wb_i2c_algo_bit", "delay": 0},
    {"name": "wb_i2c_gpio", "delay": 0},
    {"name": "i2c_mux", "delay": 0},
    {"name": "wb_i2c_gpio_device gpio_sda=31 gpio_scl=32 gpio_chip_name=wb_gpio_c3000 bus_num=2", "delay": 0},
    {"name": "mdio_bitbang", "delay": 0},
    {"name": "mdio_gpio", "delay": 0},
    {"name": "wb_mdio_gpio_device gpio_mdc=33 gpio_chip_name=wb_gpio_c3000 gpio_mdio=34", "delay": 0},
    {"name": "platform_common dfd_my_type=0x40c0", "delay":0},
...
DEVICE = [
    ...
    {"name":"wb_xdpe132g5c", "bus": 30, "loc": 0x10},
...
REBOOT_CAUSE_PARA = {
    "reboot_cause_list": [
        ...
        {
            "name": "wdt_reboot",
            "monitor_point": {"gettype": "io", "io_addr": 0x989, "okval": 1, "compare_mode":"great"},
            "record": [
...
INIT_PARAM_PRE = [
    # MAC_CORE_V
    {"loc": "30-0040/hwmon/hwmon*/avs0_vout_min", "value": "750000"},
    {"loc": "30-0040/hwmon/hwmon*/avs0_vout_max", "value": "900000"},
]
    ...
    "slot0": {
        ...
        "MTD": {
            "chain1": {
                ...
                "init_cmd": [
                    ...
                    {"cmd": "modprobe wb_spi_nor_device spi_bus_num=0 spi_chip_select=0", "gettype": "cmd", "delay": 0.1},
                ],
                "finish_cmd": [
        ...
        "SYSFS": {
            "chain2": {
                ...
                "is_support_warm_upg": 0,
                "init_cmd": [
                    {"cmd": "echo 99 > /sys/class/gpio/export", "sleep": 0.1},
                    {"cmd": "echo low > /sys/class/gpio/gpio99/direction"},
                    {"path": "/dev/cpld1", "offset": 0x91, "value": 0x6, "gettype": "devfile"},
                    {"path": "/dev/cpld1", "offset": 0x90, "value": 0x1, "gettype": "devfile"},
                    {"path": "/dev/cpld1", "offset": 0xA6, "value": 0x2, "gettype": "devfile"},
                    {"path": "/dev/cpld1", "offset": 0xD4, "value": 0x0, "gettype": "devfile"},
                    {"cmd": "modprobe wb_spi_gpio", "gettype": "cmd"},
                    {"cmd": "modprobe wb_spi_gpio_device sck=139 miso=88 mosi=89 cs=87 bus=0 gpio_chip_name=wb_gpio_c3000", "gettype": "cmd"},
                    {"cmd": "modprobe wb_spi_93xx46 spi_bus_num=0 spi_cs_gpio=87", "gettype": "cmd", "delay": 0.1},
                    {"cmd": "modprobe wb_eeprom_93xx46", "gettype": "cmd", "delay": 0.1},
                ],
                "finish_cmd": [
                    {"cmd": "rmmod wb_eeprom_93xx46", "gettype": "cmd"},
                    {"cmd": "rmmod wb_spi_93xx46", "gettype": "cmd"},
                    {"cmd": "rmmod wb_spi_gpio_device", "gettype": "cmd"},
                    {"cmd": "rmmod wb_spi_gpio", "gettype": "cmd", "delay": 0.1},
                    {"path": "/dev/cpld1", "offset": 0xD4, "value": 0xff, "gettype": "devfile"},
                    {"path": "/dev/cpld1", "offset": 0xA6, "value": 0xff, "gettype": "devfile"},
                    {"path": "/dev/cpld1", "offset": 0x90, "value": 0xfc, "gettype": "devfile"},
                    {"path": "/dev/cpld1", "offset": 0x91, "value": 0xf8, "gettype": "devfile"},
                    {"cmd": "echo 1 > /sys/class/gpio/gpio99/value"},
                    {"cmd": "echo 99 > /sys/class/gpio/unexport"},
                ],
            },
        },
