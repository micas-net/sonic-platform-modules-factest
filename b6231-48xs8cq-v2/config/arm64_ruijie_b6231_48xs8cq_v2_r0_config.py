...
UPGRADE_SUMMARY = {
    ...
    "slot0": {
        ...
        "TEST": {
            "cpld": [
                {"chain": 1, "file": "/etc/.upgrade_test/0x8040/cpu_cpld_test_header.vme", "display_name": "CPU_CPLD"},
                {"chain": 2, "file": "/etc/.upgrade_test/0x8040/base_cpld_test_header.vme", "display_name": "BASE_CPLD"},
            ],
        },
    },
}
...
PRODUCT_INFO_CONF = {
    ...
    'ethaddr': '00:D0:F8:22:35:74',
    'SerialNO': '1234942570068',
    'MainFile': 'rgos.bin',
