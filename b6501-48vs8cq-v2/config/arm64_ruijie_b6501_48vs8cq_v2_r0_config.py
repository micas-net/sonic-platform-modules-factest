...
UPGRADE_SUMMARY = {
    ...
    "slot0": {
        ...
        "TEST": {
            "cpld": [
                {"chain": 1, "file": "/etc/.upgrade_test/0x803e/cpu_cpld_test_header.vme", "display_name": "CPU_CPLD"},
                {"chain": 2, "file": "/etc/.upgrade_test/0x803e/base_cpld_test_header.vme", "display_name": "BASE_CPLD"},
            ],
        },
    },
}
...
PRODUCT_INFO_CONF = {
    ...
    'ethaddr': '00:D0:F8:22:35:80',
    'SerialNO': '1234942570072',
    'MainFile': 'rgos.bin',
    'fdtname': 's6231-48xs8cq-ft2000v2-v2',
    'serial0': '157',
    'serial1': '0',
    'serial2': '0',
    'serial3': '0',
    ...
    'ProductModel': '',
    'setmac_time': '2024-12-31 17:03:12',
}
