...
static i2c_mux_pca954x_device_t i2c_mux_pca954x_device_data0 = {
    ...
    .attr = {
        ...
        .file_attr.offset           = 0xa4,
        .file_attr.mask             = 0xff,
        .file_attr.reset_on         = 0xa4,
        .file_attr.reset_off        = 0xa5,
    },
};
...
static i2c_mux_pca954x_device_t i2c_mux_pca954x_device_data30 = {
    .i2c_bus                        = 177,
    .i2c_addr                       = 0x71,
    .probe_disable                  = 1,
    .select_chan_check              = 0,
...
struct i2c_board_info i2c_mux_pca954x_device_info[] = {
    ...
    {
        .type = "wb_pca9548",
        .platform_data = &i2c_mux_pca954x_device_data30,
    },
};
