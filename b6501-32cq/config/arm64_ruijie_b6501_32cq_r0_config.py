...
OPTOE = [
    {"name": "wb_optoe1", "startbus": 34, "endbus": 65},
]
...
DEV_MONITOR_PARAM = {
    ...
    "fans": [
        {
            "name": "fan1",
            "present": {"gettype": "devfile", "path": "/dev/cpld1", "offset": 0x2050,
                        "read_len": 1, "presentbit": 0, "okval": 0},
            "device": [
...
INIT_COMMAND_PRE = [
    ...
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d0 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d1 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d2 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d3 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d4 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d5 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d6 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d7 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d8 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40d9 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40da 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40db 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40dc 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40dd 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40de 0xa7",
    "dfd_debug sysfs_data_wr /dev/cpld1 0x40df 0xa7",
...
UPGRADE_SUMMARY = {
    ...
    "slot0": {
        ...
        "TEST": {
            "cpld": [
                {"chain": 1, "file": "/etc/.upgrade_test/0x40e1/cpu_cpld_test_header.vme", "display_name": "CPU_CPLD"},
                {"chain": 2, "file": "/etc/.upgrade_test/0x40e1/base_cpld_test_header.vme", "display_name": "BASE_CPLD"},
            ],
        },
    },
}
...
PRODUCT_INFO_CONF = {
    ...
    'ethaddr': '00:D0:F8:22:35:86',
    'SerialNO': 'G1AWA5K000046',
    'MainFile': 'rgos.bin',
    'fdtname': 's6501-32cq-ft2000v2-v2',
    'serial0': '126',
    'serial1': '0',
    'serial2': '0',
    'serial3': '0',
    ...
    'setmac_ver': '11.0',
    'e2type': '40e1',
    'ethaddr_scale': '000000000003',
    'ProductModel': '',
    'setmac_time': '2025-04-17 14:37:12',
}
