...
devices = {
    ...
    "fans": [
        {
            ...
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {'loc': '/dev/cpld1', "offset": 0x2060, "len": 1, "way": "devfile"},
        ...
        },
        {
            ...
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {'loc': '/dev/cpld1', "offset": 0x2061, "len": 1, "way": "devfile"},
        ...
        },
        {
            ...
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {'loc': '/dev/cpld1', "offset": 0x2062, "len": 1, "way": "devfile"},
        ...
        },
        {
            ...
            "Rotor": {
                "Rotor1_config": {
                    "name": "Rotor1",
                    "Set_speed": {'loc': '/dev/cpld1', "offset": 0x2063, "len": 1, "way": "devfile"},
    ...
    "cplds": [
        ...
        },
        {
            "name": "RAS_CPLD",
            "cpld_id": "CPLD4",
            "VersionFile": {"loc": "/dev/cpld1", "offset": 0x6090, "len": 4, "way": "devfile_ascii"},
    ...
    "sfps": {
        ...
        "eeprom_path_key": list(range(1, 33)),
        "optoe_driver_path": "/sys/bus/i2c/devices/i2c-%d/%d-0050/dev_class",
        "optoe_driver_key": list(range(34, 66)),
