...
3、增加版本信息打印
24-05-29 v0.3
1、400G TH5设备使用默认800G端口配置测试版本
24-12-03 
1、CPO设备报文多了会丢包，原因还不知道，先减少一点报文
 */
cint_reset();
...
const char *platform = "m2-w6940-128x1-fr4";
const char *ver = "v0.2 24-12-03";
...
int step1_pkt_type = 53; // cpo不知道为啥会缓存超了
...
/* bcm78900_b0-generic-64x800 */
int front_port_list[64] = {
      1,  2, 11, 12, 22, 23, 33, 34, 44, 45, 55, 56, 66, 67, 77, 78, 88, 89, 99,100,110,111,121,122,132,133,143,144,154,155,165,166,176,177,187,188,198,199,209,210,220,221,231,232,242,243,253,254,264,265,275,276,286,287,297,298,308,309,319,320,330,331,341,342
};
int front_port_num = 64;
char *front_port_name = "d3c";
