...
DRIVERLISTS = [
    ...
    {"name": "wb_i2c_mux_pca954x_device_b3", "delay": 0},
        ...
        "MTD": {
            "chain9": {
                ...
                "init_cmd": [
                    # firmware upgrade set sysled blue/amber alternate flashing
                    {"gettype": "devfile", "path": "/dev/cpld1", "offset": 0x50, "value": [0x01]},
                    # Switch to the master BIOS upgrade
                    #{"gettype": "devfile", "path": "/dev/cpld1", "offset": 0x1a, "value": [0x1b]},
                ...
                "finish_cmd": [
                    ...
                    # Restore BIOS upgrade
                    #{"gettype": "devfile", "path": "/dev/cpld1", "offset": 0x1a, "value": [0x0b]},
                    # Set BIOS boot from master
                    #{"gettype": "devfile", "path": "/dev/cpld1", "offset": 0x1e, "value": [0x00]},
                ],
            },
        },
