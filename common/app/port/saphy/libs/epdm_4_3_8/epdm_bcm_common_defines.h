...
#define BCM_PLP_WARM_BOOT (1U << 0)
#define BCM_PLP_AN_MODE_CL37 (1U << 1)
#define BCM_PLP_CL37_SGMII_MASTER_MODE (1U << 2)
#define BCM_PLP_SGMII_MODE_RECONFIG (1U << 14)
#define BCM_PLP_CLEAR_MAC_STAT      (1U << 15)  /*Clear MAC Stats*/
#define BCM_PLP_SGMII_REG_ACCESS_MODE (1U << 16) /* Some chips require to enable SGMII access mode to access SGMII registers */ 
#define BCM_PLP_PCS_LOGICAL_LANES 5
#define BCM_PLP_PCS_ENCODED_BIT_STREAMS 20 /* 20 lanes per 100G are logical lanes per IEEE clause 82 */
#ifdef _STDINT_H
...
/*
 * This displays customized diag parameters like
 * pcs_sync, pcs_block_lock, pcs_rx_fault, pcs_tx_fault,
 * pmd_rx_fault, pmd_tx_fault, hi_ber, ber_count, delay_skew
 */
#define BCM_PLP_CUSTOM_DIAG_DUMP (1 << 14)
...
#define BCM_PLP_AVS_REGULATORS_MAX         2
#define BCM_PLP_AVS_REGULATOR_CHANNELS_MAX 4
...
typedef enum bcm_pm_ref_clk_e {
    ...
    bcm_pm_RefClk303P830Mhz, /**< 303P830Mhz */
    bcm_pm_RefClk303P831Mhz, /**< 303P831Mhz */
    bcm_pm_RefClk305P175Mhz, /**< 305P175Mhz */
    bcm_pm_RefClk305P176Mhz, /**< 305P176Mhz */
    bcm_pm_RefClkCount
} bcm_pm_ref_clk_t;
...
/*
 * Supported modes for USXGMII configuration
 */
typedef enum bcm_pm_usxgmii_mode_e {
    bcmpmUsxgmiiModeDisable = 0x0, /**< Disable USXGMII mode */
    bcmpmUsxgmiiModeSingle  = 0x1, /**< 1-to-1 aggregation single mode*/
    bcmpmUsxgmiiModeDual    = 0x2, /**< 1-to-2 aggregation dual mode*/
    bcmpmUsxgmiiModeQuad    = 0x4, /**< 1-to-4 aggregation quad mode*/
    bcmpmUsxgmiiModeOctal   = 0x8, /**< 1-to-8 aggregation octal mode*/
    bcmpmUsxgmiiModeAutoNeg    = 0x10, /**< Link properties propogation from line to system side */
    bcmpmUsxgmiiModeLocalFault = 0x20, /**< Indicate local fault to system side when line side link is down*/
    bcmpmUsxgmiiModeFreqUnlock = 0x40, /**< Unlock MAC/PHY frequency */
 ...
 */
 typedef enum bcm_plp_failover_mode_e {
    ...
    bcmplpFailovermodeEnable, /* enable Failover mode to perform switch over */
    /* For Millenio Family Chips only */
    bcmplpFailovermodePrimary = 0,
    bcmplpFailovermodeSecondary = 1,
    /* For Barchetta Family Chips only  */
    bcmplpFailovermodeSwitchToPrimary = 0x21,   /* Switch over to primary path   */
    bcmplpFailovermodeSwitchToSecondary = 0x31, /* Switch over to secondary path */
...
/*! Loopback mode enum */
typedef enum bcm_plp_loopback_mode_e {
    bcmplpLpbkModeDigitalLoopback = 1,               /* Digital PMD loopback (not supported by all PHYs) */
    bcmplpLpbkModeRemoteLoopback = 2,                /* Remote PMD loopback (not supported by all PHYs) */
    bcmplpLpbkModeAnalogInternalLoopback = 3,        /* Analog internal loopback (not supported by all PHYs) */
                                                     /* Below are for 10GBase copper PHYs only */
    bcmplpLpbkModeDigitalLoopbackMatchLineSpeed = 1, /* Set digital loopback matching line side speed */
    bcmplpLpbkModeDigitalLoopback100M = 2,           /* Set digital loopback for 100M */
    bcmplpLpbkModeDigitalLoopback1G = 3,             /* Set digital loopback for 1G */
    bcmplpLpbkModeDigitalLoopback10G = 4,            /* Set digital loopback for 10G */
    bcmplpLpbkModeDigitalLoopback2p5G = 5,           /* Set digital loopback for 2.5G */
    bcmplpLpbkModeDigitalLoopback5G = 6,             /* Set digital loopback for 5G */
    bcmplpLpbkModeDigitalLoopback7p5G = 7,           /* Set digital loopback for 7.5G */
    bcmplpLpbkModeDigitalLoopback25G = 8,            /* Set digital loopback for 25G */
    bcmplpLpbkModeRemoteLoopbackXgBaseT = 10         /* Remote loopback */
}bcm_plp_loopback_mode_t;
...
typedef enum bcm_plp_tech_ability_ext_e {
    ...
    bcmplpAnCapMSA_800G_CR8_KR8 = 0x10000,  /* AN_CAP_MSA_800G_CR8_KR8[Consortium]  */
    bcmplpAnCapBAM_800G_CR8_KR8 = 0x20000   /* AN_CAP_BAM_800G_CR8_KR8[Proprietary] */
...
typedef enum bcm_plp_fec_ability_s {
    ...
    bcmplpFecRS544_2XN = 0x80,         /** RS 544 interleaved FEC */
    bcmplpFecRS272_2XN = 0x100,        /** RS 272 interleaved FEC */
    bcmplpFecRS272Requested = 0x200,   /** RS 272 Requested       */
 ...
 *
 * \arg an_status \n
 *   Auto Negotiation status. This param is ignored for bcm_plp_mode_config_get API \n
 *     AN_DISABLE            = 0x0, \n
 *     AN_ENABLE             = 0x1, \n
...
typedef enum bcm_plp_lane_data_rate_e {
    ...
    bcmplpLaneDataRate_2P125G     = (2125),
    bcmplpLaneDataRate_2P4576G    = (2457),
    bcmplpLaneDataRate_3P072G     = (3072),
    ...
    bcmplpLaneDataRate_8P5G       = (8500),
    bcmplpLaneDataRate_9P800G     = (9800),
    bcmplpLaneDataRate_9P8304G    = (9830),
    bcmplpLaneDataRate_9P95328G   = (9953),
    bcmplpLaneDataRate_10P1376G   = (10137),
    bcmplpLaneDataRate_10P3125G   = (10312),
    ...
    bcmplpLaneDataRate_55P90473G  = (55905),
    bcmplpLaneDataRate_55P90474G  = (55905),
    bcmplpLaneDataRate_56G        = (56000),
    bcmplpLaneDataRate_56P1G      = (56100),
    bcmplpLaneDataRate_56P1522G   = (56152),
    bcmplpLaneDataRate_56P1523G   = (56152),
    bcmplpLaneDataRate_56P25G     = (56250),
    bcmplpLaneDataRate_57G        = (57000),
    bcmplpLaneDataRate_85G        = (85000),
    bcmplpLaneDataRate_90G        = (90000),
    bcmplpLaneDataRate_95G        = (95000),
    bcmplpLaneDataRate_100G       = (100000),
    bcmplpLaneDataRate_101P25G    = (101250),
    bcmplpLaneDataRate_102P5G     = (102500),
    bcmplpLaneDataRate_105G       = (105000),
    bcmplpLaneDataRate_106P25G    = (106250),
    bcmplpLaneDataRate_110G       = (110000),
    bcmplpLaneDataRate_111P809G   = (111809),
    bcmplpLaneDataRate_112P2G     = (112200),
    bcmplpLaneDataRate_112P304G   = (112304),
 ...
 *   To select the hitless mux mode feature on the chip  0: non-hitless mux mode, 1: Hitless mux mode,\n
 *       2: Hybrid hitless mux mode, 3: PMD hitless mux mode \n
 *
...
typedef enum bcm_plp_port_type_e {
    bcmplpPortTypePassthrough = 0,  /* Passthrough Port (one to one mapping between system and line sides)*/
    bcmplpPortTypeGearBox,          /* Gearbox port*/
    bcmplpPortTypeReverseGearBox    /* Reverse Gearbox port*/
}bcm_plp_port_type_t;

/* Timesync(PTP) configuration on Egress and Ingress side of a chip */
typedef enum bcm_plp_1588_config_e {
    bcmplpPTPDisabled = 0,                     /* PTP disabled*/
    ...
    bcmplpPTPHybNseEnabled ,                   /* Hybrid mode for Egress & NSE for Ingress (packets not encrypted)*/
    bcmplpPTPHybPmEnabled ,                    /* Hybrid mode for Egress & PM for Ingress (packets encrypted)*/
                                               /* Value 7 is reserved for future use*/
    bcmplpPTPNse2SEnabled = 8,                 /* NSE-TS (B0 Plan A) for Egress & Ingress (packets encrypted) - 2 Stage*/
    bcmplpPTPNsePm2SEnabled                    /* NSE-TS (B0 Plan A) for Egress & PM-TS for Ingress (packets encrypted) - 2 Stage*/
} bcm_plp_1588_config_t;

/* Aperta port FEC types */
typedef enum bcm_plp_aperta_fec_mode_select_e {
    bcmplpapertaNoFEC = 0,           /* No FEC*/
    bcmplpapertaRS544,               /* RS 544 FEC*/
    bcmplpapertaBaseR,               /* BaseR FEC*/
    bcmplpapertaRSFEC,               /* RS FEC */
    bcmplpapertaRS272,               /* RS 272 FEC*/
    bcmplpapertaRS544_2XN            /* RS544 interleaved FEC */
...
*
*  \arg egr_ptp_fixed_latency \n
*     This defines the number of dp_ck clock cycles. Applicable only for chip revision B0.
*
*  \arg port_type \n
...
/* Agera2 supported FEC/PCS types */
typedef enum bcm_plp_agera2_fec_pcs_type_sel_e {
    bcmplpagera2NoFECNoPCS    = 0x00,      /* No FEC No PCS*/
    bcmplpagera2RS544         = 0x01,      /* RS544 - KP */
    bcmplpagera2RS528         = 0x02,      /* RS 528 - KR FEC*/
    bcmplpagera2RS544_2XN     = 0x03,      /* RS544 interleaved FEC*/
    /* Reserved for future use */
    bcmplpagera2PCSIEEE       = 0x11,      /* 100G, 50G, 25G, 10G PCS, depending upon mode different IEEE clause is applicable */
    bcmplpagera2PCS_CONS      = 0x12,      /* PCS consortium is supported for 25G and 50G consortium mode. It is selected when other side PCS is also same */
    bcmplpagera2FecCount
} bcm_plp_agera2_fec_pcs_type_sel_t;

/* Agera2 DP (Datapath) Mode Option (Simple Retimer / FEC_PCS Mode) */
typedef enum bcm_plp_agera2_dp_mode_e {
    bcmplpagera2DpModePassThru = 0,          /* DP Mode - Simple Retimer */
    bcmplpagera2DpModeTermGen,               /* DP Mode - FEC / PCS Term & Gen Mode */
    bcmplpagera2DpModeFecDecEnc,             /* DP Mode - FEC DEC_ENC Term & Gen Mode (Bypass XDEC_XENC) [Supports only 1x100G_RS544 mode] */
    bcmplpagera2DpModeCount
} bcm_plp_agera2_dp_mode_t;

/* Selecting FEC mode options
  * \arg fec_pcs_type \n
  *    Select FEC/PCS type option
  * \arg dp_mode \n
  *    Selct FEC option to select pass thru or terminate and generate for the selected fec type
  *
  */
typedef struct bcm_plp_agera2_fec_pcs_mode_s {
    bcm_plp_agera2_fec_pcs_type_sel_t fec_pcs_type;
    bcm_plp_agera2_dp_mode_t dp_mode;
} bcm_plp_agera2_fec_pcs_mode_t;

/*! Agera2 Failover configuration
 *
 * \arg lane_map \n
 *  Lane map of the failover port
 *
 */
typedef struct bcm_plp_agera2_failover_configuration_s {
    unsigned int  lane_map;
} bcm_plp_agera2_failover_configuration_t;

/*! Agera2 device aux mode
*
*  This structure can be used to set up multiple modes that agera2 supports. \n
*  This structure is used in bcm_plp_mode_config_set/bcm_plp_mode_config_get APIs.
*
* \arg lane_data_rate \n
*   Agera2 supports multiple lane data rates on System and Line side.
*   Per lane data rate of the port. Ex: For 53.125G. lane_data_rate = bcmplpLaneDataRate_53P125G \n
*
*   When port is created of more than one lane; port speed is same as PCS/MAC port speed
*   and lane data rate will be different based on number of lanes. \n
...
*
* \arg fec_pcs_mode  \n
*  Select FEC/PCS type and DP mode options (pass thru or terminate-generate)
*
* \arg failover_config \n
*   Select the lane map of the secondary port in case of fail over mode.\n
*   In case of non-failover modes the failover_config.lane_map should be zero for both sides(Line and System). \n
*   In case of failover modes the failover_config.lane_map should be non-zero in either of the sides(Line or System) .\n
*   Note: Hitless mux mode will be enabled only when fec_pcs_mode.dp_mode = 1.\n
*  For supported lane_data_rate and modulation_mode, please refer to product specific data sheet\n
*
* \arg tx_squelch_on_rx_lock_loss  \n
*  Tx squelch on Rx lock loss. \n
*  tx_squelch_on_rx_lock_loss = 0, Opposite side tx squelch on RX loss of lock feature is disabled \n
*  tx_squelch_on_rx_lock_loss = 1, Opposite side tx squelch on RX loss of lock feature is enabled  \n
*/
typedef struct bcm_plp_agera2_device_aux_modes_s {
    bcm_plp_lane_data_rate_t                 lane_data_rate;
    bcm_plp_modulation_mode_t                modulation_mode;
    unsigned char                            clock_mode;
    bcm_plp_agera2_fec_pcs_mode_t            fec_pcs_mode;
    bcm_plp_agera2_failover_configuration_t  failover_config;
    unsigned char                            tx_squelch_on_rx_lock_loss ;
} bcm_plp_agera2_device_aux_modes_t;

/* Supported VCO types to configure */
typedef enum bcm_plp_pll_vco_e{
    bcmplpVco51G = 0,    /* 51G VCO*/
    bcmplpVco53G = 1     /* 53G VCO*/
}bcm_plp_pll_vco_t;

/* Aperta2 line and system side VCO selection */
typedef struct bcm_plp_aperta2_pll_vco_config_s {
    bcm_plp_pll_vco_t sys_vco;       /* System side VCO */
    bcm_plp_pll_vco_t line_vco;      /* Line Side VCO */
} bcm_plp_aperta2_pll_vco_config_t;

/* Aperta2 supported FEC types */
typedef enum bcm_plp_aperta2_fec_mode_sel_e {
    bcmplpaperta2NoFEC = 0,           /* No FEC*/
    bcmplpaperta2RS544,               /* RS544 */
    bcmplpaperta2RS528,               /* RS 528 FEC*/
    bcmplpaperta2RS272,               /* RS 272 FEC */
    bcmplpaperta2RS272_2XN,           /* RS272 Interleaved FEC*/
    bcmplpaperta2RS544_2XN,           /* RS544 interleaved FEC*/
    bcmplpaperta2FecCount
}bcm_plp_aperta2_fec_mode_sel_t;

/*! Aperta2 Failover configuration
 *
 * \arg lane_map \n
 *  Lane map of the failover port
 *
 ...
 *  1 : TX Back-pressure OR'ed from both ports(Failover and active port)
 */
typedef struct bcm_plp_aperta2_failover_configuration_s {
    unsigned int lane_map;
    unsigned int tx_back_pressure_mode;
}bcm_plp_aperta2_failover_configuration_t;

/*!
 * @enum bcm_plp_fixed_latency_start_point_e
 * @brief Fixed latency starting point
 */
typedef enum bcm_plp_fixed_latency_start_point_e {
    bcmplpStartPointWCtimer = 0, /* Wall clock timer */
    bcmplpStartPointPMRx         /* Port Macro Rx    */
} bcm_plp_fixed_latency_start_point_t;
 ...
 *
 */
typedef struct bcm_plp_fixed_latency_config_s {
    unsigned int enable;
    unsigned int start_point;
    unsigned int dp_ck_cycles;
} bcm_plp_fixed_latency_config_t;

typedef bcm_plp_fixed_latency_config_t bcm_plp_aperta2_ing_fixed_latency_config;
typedef bcm_plp_fixed_latency_config_t bcm_plp_aperta2_egr_fixed_latency_config;

typedef enum bcm_plp_octal_crossing_e {
    bcmplpNoOctalCrossing = 0,       /* No Octal Crossing */
    bcmplpSysOctalCrossing ,         /* System Side Octal crossing*/
    bcmplpLineOctalCrossing          /* Line Side Octal Crossing*/
} bcm_plp_octal_crossing_t;
...
*   Lane map of the secondary port in case of fail over mode.\n
*
*  \arg ing_fixed_latency \n
*   Ingress fixed latency configuration\n
*
*  \arg egr_fixed_latency \n
*   Egress fixed latency configuration\n
*
*
*  \arg ts_config \n
*   Time Sync configuration\n
...
typedef struct bcm_plp_aperta2_device_aux_modes_s {
    bcm_plp_lane_data_rate_t                         lane_data_rate    ;
    bcm_plp_modulation_mode_t                        modulation_mode   ;
    bcm_plp_aperta2_fec_mode_sel_t                   fec_mode_sel      ;
    bcm_plp_aperta2_failover_configuration_t         failover_config   ;
    bcm_plp_aperta2_ing_fixed_latency_config         ing_fixed_latency;
    bcm_plp_aperta2_egr_fixed_latency_config         egr_fixed_latency;
    bcm_plp_1588_config_t                            ts_config;
    bcm_plp_port_type_t                              port_type;
    bcm_plp_octal_crossing_t                         octal_crossing;
} bcm_plp_aperta2_device_aux_modes_t;
...
typedef struct bcm_plp_pam4_tx_s {
    ...
    bcm_plp_value_override_t  tx_pi_freq_override; /*TX Phase interpolator frequency override*/
}bcm_plp_pam4_tx_t;
...
typedef struct bcm_plp_pm_phy_pam4_diagnostics_s {
    ...
    unsigned char signal_detect_latch;       /* Signal detect latch status of a lane*/
    unsigned char cdr_lock_status_latch;     /* CDR lock latch status of a lane*/
    unsigned int laneid;                     /* Currently Selected Lane index */
    unsigned char rx_pam_mode;               /* RX PAM4 Mode */
    unsigned char CDR;                       /* Baud Rate Phase Detector enable */
    char tx_osr_mode_str[16];                /* OSR Mode TX String */
    char rx_osr_mode_str[16];                /* OSR Mode RX String */
    unsigned short UC_CFG;                   /* uC lane configuration */
    unsigned short UC_STS_EXT;               /* Extended uC lane status */
    unsigned char sig_det_chg;               /* Signal Detect Change */
    unsigned char pmd_lock_chg;              /* PMD RX Lock Change */
    unsigned char TP0;                       /* Echos 'RX_Channel_Loss_hint' provided by user in both PAM4 and NRZ modes */
    unsigned char TP1;                       /* Initial Channel Loss Estimate from 0-50: Range corresponds to short to long channels */
    unsigned char TP2;                       /* AFE Static BW setting, only applies to short channels */
    int ffe_n3;                              /* RX FFE n3 */
    int ffe_n2;                              /* RX FFE n2 */
    int ffe_n1;                              /* RX FFE n1 */
    int ffe_m;                               /* RX FFE m  */
    int ffe_p1;                              /* RX FFE p1 */
    int ffe_p2;                              /* RX FFE p2 */
    int FLT_M;                               /* Floating Tap Values - Max Magnitude of All Floating Taps */
    unsigned short FLT_S;                    /* Floating Tap Values - Absolute Sum of Magnitudes of All Taps */
    unsigned char linktrn_en;                /* TX Link Training Enable */
    char snr_str[10];                        /* SNR string in dB */
    unsigned char tx_prec_en;                /* TX Precoder Enable */
    int EYE_U;                               /* Upper Eye margin @ 1e-5 (NRZ) or 1e-3 (PAM4) as seen by internal diagnostic slicer in mV */
    int EYE_M;                               /* Middle Eye margin @ 1e-5 (NRZ) or 1e-3 (PAM4) as seen by internal diagnostic slicer in mV */
    int EYE_L;                               /* Lower Eye margin @ 1e-5 (NRZ) or 1e-3 (PAM4) as seen by internal diagnostic slicer in mV */
    char ber_str[32];                        /* BER String       */
    unsigned char rx_tuning_done;            /* RX Tuning Done */
    unsigned char enable_6taps;              /* 6 Tap Mode Enabled */
    unsigned char disable_eye_display;       /* Control for disabling the display of eye margin set */
    unsigned char tx_pam_mode;               /* TX PAM4 Mode */
    unsigned char tx_disable_status;         /* TX Disable Status */
    char txfir_nlc_upper_pct;                /* TX nonlinear compenstation upper eye percent used for determining asymmetry status */
    char txfir_nlc_lower_pct;                /* TX nonlinear compenstation lower eye percent used for determining asymmetry status */
    unsigned char txfir_use_pam4_range;      /* TX equalization FIR tap range */
    unsigned char tx_pmd_dp_invert;          /* Is tx pmd dp inverted? */
    unsigned char rx_pmd_dp_invert;          /* Is rx pmd dp inverted? */
    unsigned char rmt_lpbk_en;               /* Is remote loopback enabled? */
    unsigned char dig_lpbk_en;               /* Is digital loopback enabled? */
    unsigned char ilb_en;                    /* Is internal (analog) loopback enabled? */
    unsigned char tx_pi_en;                  /* Is Tx PI enabled? */
    char uc_sts_decoded[512];                /* UC Status Decoded */
    char uc_sts_ext_decoded[512];            /* uc_sts_ext_decoded */
 ...
 *
 * \arg temperature \n
 *     Core Temperature in Celcius.\n
 * \arg voltage \n
 *     Core voltage in millivolts(mV).
 * \arg pll_range \n
 *     PLL Range value for applicable PHYs.  Refer to respective user guide for more details.\n
 */
...
/*!bcm_plp_aperta2_fw_init_params_t
  * This structure is intended to initialize HW configuration after FW download
  * \arg macsec_option\n
  * When bit0 is set to 1, macsec Ingress side on Octal0 is bypassed.
  * When bit1 is set to 1, macsec Egress side on Octal0 is bypassed.
  * When bit2 is set to 1, macsec Ingress side on Octal1 is bypassed.
  * When bit3 is set to 1, macsec Egress side on Octal1 is bypassed.
  * \arg ptp_option\n
  * When bit0 is set to 1, PTP on Octal0 is bypassed.
  * When bit1 is set to 1, PTP on Octal1 is bypassed.
  * When bit2 is set to 1, PTP configured on Synchronous mode, 0 represents Asynchronous mode
  * When bit3 is set to 1, PTP external reference clock invert enable, 0 otherwise.
  * \arg octal0 \n
  * Octal0 System and line side VCO configuration
  * \arg octal1 \n
  * Octal1 System and line side VCO configuration
  * \arg sys_lane_swap\n
  * Configure Tx and Rx lane swap for System side of Aperta2.
  * \arg line_lane_swap\n
  * Configure Tx and Rx lane swap for Line side of Aperta2.
  *
  * NOTE: Aperta2 does not support asynchronous tx/rx swaps, i.e., Tx and Rx arrays are always expected to be the same.
  */
typedef struct bcm_plp_aperta2_fw_init_params_s {
    unsigned int  macsec_option;
    unsigned int  ptp_option;
    bcm_plp_aperta2_pll_vco_config_t octal0;
    bcm_plp_aperta2_pll_vco_config_t octal1;
    bcm_laneswap_map_t  sys_lane_swap;
    bcm_laneswap_map_t  line_lane_swap;
} bcm_plp_aperta2_fw_init_params_t;
...
/*! bcm_plp_phy_mode_sel_t \n
  *
  * Select phy mode of operation  \n
  *
  * bcmplpOctalSplitNone : 0x00  : No octal split on both sides. System-side: Lanes [0-7]  OCTAL0; Lanes [8-15]  OCTAL1
  *                                               Line-side: Lanes [0-7]  OCTAL0; Lanes [8-15]  OCTAL1.\n
  * bcmplpOctalSplitSys   : 0x01  : Octal split on system-side. System-side: Lanes [0-3, 12-15]  OCTAL0; Lanes [4-7, 8-11] OCTAL1.
  *                                               Line-side: Lanes [0-7]  OCTAL0; Lanes [8-15]  OCTAL1. \n
  * bcmplpOctalSplitLine  : 0x02   : Octal split on Line-side. Line-side: Lanes [0-3, 12-15]  OCTAL0; Lanes [4-7, 8-11] OCTAL1.
  *                                               System-side: Lanes [0-7]  OCTAL0; Lanes [8-15]  OCTAL1. \n
  * bcmplpOctalSplitBoth : 0x03   : Octal split on both-side.  System-side: Lanes [0-3, 12-15]  OCTAL0; Lanes [4-7, 8-11]  OCTAL1.
  *                                               Line-side: Lanes [0-3, 12-15] OCTAL0; Lanes [4-7, 8-11]  OCTAL1. \n
  */
typedef enum bcm_plp_phy_mode_sel_e {
    bcmplpOctalSplitNone = 0x00,
    bcmplpOctalSplitSys  = 0x01,
    bcmplpOctalSplitLine = 0x02,
    bcmplpOctalSplitBoth = 0x03
} bcm_plp_phy_mode_sel_t;
...
/*!bcm_plp_agera2_fw_init_params_t
  * This structure is intended to configure agera PHY after FW download
  * \arg ref_clk      : Reference clock information required for PHY configuration.\n
  * \arg phy_mode :  Select phy mode of operation \n
  *
  */
typedef struct bcm_plp_agera2_fw_init_params_s {
    bcm_plp_pm_ref_clk_t  ref_clk;
    bcm_plp_phy_mode_sel_t phy_mode;
} bcm_plp_agera2_fw_init_params_t;
...
typedef struct bcm_plp_fec_dump_status_s {
    ...
    bcm_plp_fec_rx_err_cnt_t fec_b_err_cnt;    /**< fec err counter struct - only for 100G-Interleaved FEC, 200G , 400G or 800G */
    bcm_plp_fec_rx_err_cnt_t fec_c_err_cnt;    /**< fec err counter struct - only for 800G */
    bcm_plp_fec_rx_err_cnt_t fec_d_err_cnt;    /**< fec err counter struct - only for 800G */
...
typedef enum  bcm_plp_base_t_ctrl_e {
    ...
    bcmplpBaseTCtrlPreambleAlignment,               /* Control preamble alignment to interoperate with
                                                     * non-IEEE-standard PHYs */
...
typedef enum bcm_plp_base_t_automedium_e {
    bcmplpBaseTAutomediumDefault = 0,  /* Keep software defaults for backward compatibility */
                                       /* Automedium is enabled by default */
    bcmplpBaseTAutomediumEnable  = 1,  /* Enable automedium */
    bcmplpBaseTAutomediumDisable = 2   /* Disable automedium */
} bcm_plp_base_t_automedium_t;
...
typedef struct bcm_plp_base_t_device_aux_modes_s {
    ...
    void         *ctrl_data_ptr;
    unsigned int  automedium;          /* Use bcm_plp_base_t_automedium_t to configure whether both */
                                       /* copper and fiber media types are selected or not */
    unsigned int  media_preferred;     /* Configure media precedence, Copper = 0, Fiber = 1 */
...
typedef enum bcm_plp_base_t_diag_ctrl_type_e {
    ...
    bcmplpBaseTDiagCtrltypeCmd  =  2,    /* a sequence of command actions */
...
typedef enum  bcm_plp_peripheral_device_e {
    bcmplpPeriDevI2c  = 0x10000     /* I2C  bus */
} bcm_plp_peripheral_device_t;

typedef enum  bcm_plp_peripheral_device_control_e {
    bcmplpPeriDevCtrlDataFlush,    /* flush data            */
    bcmplpPeriDevCtrlBusSpeedGet,  /* get bus speed         */
    bcmplpPeriDevCtrlBusSpeedSet   /* set bus speed         */
} bcm_plp_peripheral_device_control_t;

typedef enum  bcm_plp_peripheral_device_speed_e {
    bcmplpPeriDevI2cBusSpeed100kbps,   /* I2C bus speed 100Kbps  */
    bcmplpPeriDevI2cBusSpeed400kbps    /* I2C bus speed 400Kbps  */
} bcm_plp_peripheral_device_speed_t;

typedef struct bcm_plp_peripheral_dev_ctrl_data_s {
    int   value;
} bcm_plp_peripheral_dev_ctrl_data_t;
...
typedef enum bcm_plp_timesync_inband_filter_flags_e {
    ...
    bcmplpTimesyncFilterFlagMatchIpv6    = (1U <<  4)
...
typedef enum bcm_plp_timesync_flag_e {
    bcmplpTimesyncFlagCaptureStampEnable            = (1U<<0),  /* Enable TimeStamp capturing */
    bcmplpTimesyncFlagHeartbeatStampEnable          = (1U<<1),  /* Capture HeartBeat on next FrameSync event */
    bcmplpTimesyncFlagRXCrcEnable                   = (1U<<2),  /* Enable the CRC check in ingress PTP messages */
    bcmplpTimesyncFlag8021asEnable                  = (1U<<3),  /* Enable 802.1AS MAC DA check for PTP messages */
    bcmplpTimesyncFlagL2Enable                      = (1U<<4),  /* Enable the L2  MAC DA check for PTP messages */
    bcmplpTimesyncFlagIp4Enable                     = (1U<<5),  /* Enable the L4 IPv4 DA check for PTP messages */
    bcmplpTimesyncFlagIp6Enable                     = (1U<<6),  /* Enable the L4 IPv6 DA check for PTP messages */
    bcmplpTimesyncFlagClockSrcExt                   = (1U<<7),  /* Reference clock source:  0=internal  1=external */
    bcmplpTimesyncFlagClockSrcExtMode               = (1U<<8),  /* External Reference clock source: 0=PHY_REFCLK 1=PLP_XTAL_CLK */
    bcmplpTimesyncFlag1588EncryptedMode             = (1U<<9),  /* Enable IEEE1588 Encrypted Mode */
    bcmplpTimesyncFlagFollowUpAssistEnable          = (1U<<10), /* Enable Follow-Up Assist */
    bcmplpTimesyncFlagDelayRespAssistEnable         = (1U<<11), /* Enable Delay-Response Assist */
    bcmplpTimesyncFlag64BitTimestampEnable          = (1U<<12), /* Enable 64-bit TimeStamp */
    bcmplpTimesyncFlag1588OverHsrEnable             = (1U<<13), /* Enable HSR Parser & LLC Check */
    bcmplpTimesyncFlagCaptureTimestampTxSync        = (1U<<14), /* Capture TimeStamp for egress PTP Sync messages */
    bcmplpTimesyncFlagCaptureTimestampTxDelayReq    = (1U<<15), /* Capture TimeStamp for egress PTP DelayReq messages */
    bcmplpTimesyncFlagCaptureTimestampTxPdelayReq   = (1U<<16), /* Capture TimeStamp for egress PTP PDelayReq messages */
    bcmplpTimesyncFlagCaptureTimestampTxPdelayResp  = (1U<<17), /* Capture TimeStamp for egress PTP PDelayResp messages */
    bcmplpTimesyncFlagCaptureTimestampRxSync        = (1U<<18), /* Capture TimeStamp for ingress PTP Sync messages */
    bcmplpTimesyncFlagCaptureTimestampRxDelayReq    = (1U<<19), /* Capture TimeStamp for ingress PTP DelayReq messages */
    bcmplpTimesyncFlagCaptureTimestampRxPdelayReq   = (1U<<20), /* Capture TimeStamp for ingress PTP PDelayReq messages */
    bcmplpTimesyncFlagCaptureTimestampRxPdelayResp  = (1U<<21), /* Capture TimeStamp for ingress PTP PDelayResp messages */
    bcmplpTimesyncFlagTXCrcEnable                   = (1U<<22), /* Enable the CRC check in egress PTP messages */
    bcmplpTimesyncDisabled                          = (1U<<23), /* NSE/PM TimeStamping disabled */
    bcmplpTimesyncNseEnabled                        = (1U<<24), /* NSE-TS for both egress and Ingress */
    bcmplpTimesyncNsePmEnabled                      = (1U<<25), /* NSE-TS for egress and  PM-TS for Ingress */
    bcmplpTimesyncPmEnabled                         = (1U<<26), /* PM-TS for egress and  PM-TS for Ingress */
    bcmplpTimesyncPmNseEnabled                      = (1U<<27), /* PM-TS for egress and NSE-TS for Ingress */
    bcmplpTimesyncNse2SEnabled                      = (1U<<28), /* NSE-TS (B0 Plan A) for Egress and Ingress (packets encrypted) - 2 Stage */
    bcmplpTimesyncNsePm2SEnabled                    = (1U<<29), /* NSE-TS (B0 Plan A) for Egress and PM-TS for Ingress (packets encrypted) - 2 Stage */
    bcmplpTimesyncHybNseEnabled                     = (1U<<30), /* Hybrid for Egress and NSE-TS for Ingress (packets not encrypted)*/
    bcmplpTimesyncHybPmEnabled                      = (1U<<31), /* Hybrid for Egress and PM-TS for Ingress (packets encrypted)*/
...
typedef enum bcm_plp_timesync_syncmode_ctrl_e {
    ...
    bcmplpTimesyncSyncmodeCtrlPPSEnable      = (1U << 14), /* Enable PPS to load TOD into the phy timer */
    bcmplpTimesyncSyncmodeCtrlTODLoadOnce    = (1U << 15), /* Enable TOD load one time into PHY timer   */
...
typedef enum bcm_plp_timesync_timing_control_e {
    ...
    bcmplpTimesyncTimerTypeTimeOfDayTSDpll80    = 0x600070D7,  /*  80-bit Time of Day TimeStamp (ToD) and TOD DPLL  */
    bcmplpTimesyncTimerTypeTimeOfDayTSDpll48    = 0x600070D8,  /*  48-bit Time of Day TimeStamp (ToD) and TOD DPLL  */
...
typedef enum bcm_plp_timesync_sopmem_field_e {
    ...
    bcmplpTimesyncSOPmemClassifiedData = (1U << 7),  /* classified data such as  *\
                                                     \*  MAC or IP addr or MPLS  */
    bcmplpTimesyncSOPmemSrcIP          = bcmplpTimesyncSOPmemClassifiedData,
...
typedef enum bcm_plp_timesync_sopmem_option_e {
    ...
    bcmplpTimesyncSOPmemOpClassify        = (1U << 8)   /* classify SOPmem data        */
...
typedef enum  bcm_plp_timesync_univ_timer_e {
    bcmplpTimesyncUnivTimerReserved   =  0,          /* reserved timer type */
    bcmplpTimesyncUnivPchSystemTime   =  (1U << 1),  /* PCH system timers   */
    bcmplpTimesyncUnivHeartbeat80bit  =  (1U << 2)   /* 80-bit HeartBeat    */
} bcm_plp_timesync_univ_timer_t;

/* PTP-v2.1 PTP lookup-Action modes --  Non-PTPv2.1 / User-defined mode / Pre-defined mode */
typedef enum  bcm_plp_timesync_ptp_action_mode_e {
    bcmplpTimesyncPtpActionModeOff        = 0, /* turn off the PTPv2.1 Lookup-Action mode */
    bcmplpTimesyncPtpActionModeInvalid    = 1, /* invalid/undefined mode */
    bcmplpTimesyncPtpActionModeUserDefine = 2, /* User-defined Lookup-Action mode */
    /* chip Pre-defined Lookup-Action modes */
    bcmplpTimesyncPtpActionModeGmSc       = 0x101, /* GrandMaster or SlaveClock normal mode      */
    bcmplpTimesyncPtpActionModeGmSc2Step  = 0x102, /* GrandMaster or SlaveClock pure 2-step mode */
    bcmplpTimesyncPtpActionModeGmScInband = 0x103, /* GrandMaster or SlaveClock inband mode      */
    bcmplpTimesyncPtpActionModeGmScOoband = 0x104, /* GrandMaster or SlaveClock out-of-band mode */
    bcmplpTimesyncPtpActionModeE2eTcRegular = 0x111, /*  End-to-End  Transparent Clock regular mode     */
    bcmplpTimesyncPtpActionModeE2eTcPartial = 0x112, /*  End-to-End  Transparent Clock partial mode     */
    bcmplpTimesyncPtpActionModeE2eTc2step   = 0x113, /*  End-to-End  Transparent Clock pure 2-step mode */
    bcmplpTimesyncPtpActionModeP2pTcRegular = 0x121, /* Peer-to-Peer Transparent Clock regular mode     */
    bcmplpTimesyncPtpActionModeP2pTcPartial = 0x122, /* Peer-to-Peer Transparent Clock partial mode     */
    bcmplpTimesyncPtpActionModeP2pTc2step   = 0x123, /* Peer-to-Peer Transparent Clock pure 2-step mode */
    /* flags for assisting action mode settings */
    bcmplpTimesyncPtpActionModePreDefine     = 0x100, /* Pre-defined Lookup-Action mode */
    bcmplpTimesyncPtpActionModeSetActionOnly = 0x800, /* do not activate actions yet    */
} bcm_plp_timesync_ptp_action_mode_t;

/* PTP-v2.1 user-defined PTP lookup actions for the nine classified PTP packet types defined */
typedef enum  bcm_plp_timesync_lookup_action_e {        /* in bcm_plp_timesync_user_action_t */
    bcmplpTimesyncLookupActionNone           =  0, /* no action */
    bcmplpTimesyncLookupActionPopTsInsertOts =  1, /* pop TS from SOPmem into OTS field in PTP packet */
    bcmplpTimesyncLookupActionAddTsCfInband  =  2, /* update CF = CF + (TxSOP - inband(RxSOP))   */
    bcmplpTimesyncLookupActionInsertRsv2     =  3, /* insert RxTS into Resv2 field in PTP header */
    bcmplpTimesyncLookupActionPushTsSopmem   =  4, /* push Rx/Tx TS and related info to SOPmem   */
    bcmplpTimesyncLookupActionSubTsCf        =  5, /* update Correction Field: CF = CF - RxTS */
    bcmplpTimesyncLookupActionAddTsCf        =  6, /* update Correction Field: CF = CF + TxTS */
    bcmplpTimesyncLookupActionInsertTsOts    =  8, /* insert TS into OTS field in PTP packet  */
} bcm_plp_timesync_lookup_action_t;
...
/*!
 * @enum bcm_plp_sync_ref_mode_e
 * @brief Enable PPS synchronous to SYNCREF, SYNCREF clocks the phy timer
 */
typedef enum  bcm_plp_sync_ref_mode_e {
    bcmplpTimesyncRefModeAsync = 0,   /* Asynchronous mode */
    bcmplpTimesyncRefModeSync         /* Synchronous mode  */
} bcm_plp_sync_ref_mode_t;

/*!
 * @enum bcm_plp_time_code_e
 * @brief flag information to select Heart beat or time code
 */
typedef enum bcm_plp_time_code_e {
    bcmplpTimesyncHeartBeatDisable = 0x0, /* Disable HeartBeat */
    bcmplpTimesyncHeartBeat48bit,         /* HeartBeat in 48bit nanosecond format */
    bcmplpTimesyncHeartBeat48bitIeee,     /* HeartBeat in 16bit second and 32bit nanosecond format */
    bcmplpTimesyncHeartBeat80bit,         /* HeartBeat in 48bit second and 32bit nanosecond format */
    bcmplpTimesyncTimeCodeDisable = 0x8,  /* Disable time code */
    bcmplpTimesyncTimeCode32bit,          /* Timecode in 32bit nanosecond format */
    bcmplpTimesyncTimeCode48bit,          /* Timecode in 48bit nanosecond format */
    bcmplpTimesyncTimeCode64bit,          /* Timecode in 64bit format */
    bcmplpTimesyncTimeCode80bit,          /* Timecode in 48bit second and 32bit nanosecond format */
    bcmplpTimesyncTimeCodeCount
} bcm_plp_time_code_t;
...
/* PTP-v2.1 data structure for specifying the user-defined PTP lookup actions for the 9 */
typedef struct  bcm_plp_timesync_user_action_s {         /* classified PTP packet types */
    bcm_plp_timesync_lookup_action_t  sync_1step;    /* one-step Sync packet */
    bcm_plp_timesync_lookup_action_t  sync_2step;    /* two-step Sync packet */
    bcm_plp_timesync_lookup_action_t  delay_request; /* Delay Request packet */
    bcm_plp_timesync_lookup_action_t  sync_followup; /* followup Sync packet */
    bcm_plp_timesync_lookup_action_t  pdelay_request;        /* PDelay Request packet */
    bcm_plp_timesync_lookup_action_t  pdelay_response_1step; /* one-step PDelay Response packet */
    bcm_plp_timesync_lookup_action_t  pdelay_response_2step; /* two-step PDelay Response packet */
    bcm_plp_timesync_lookup_action_t  pdelay_response_followup; /* folowup PDelay Response packet */
    bcm_plp_timesync_lookup_action_t  delay_response; /* Delay Response packet */
} bcm_plp_timesync_user_action_t;

typedef struct  bcm_plp_timestamp_univ_s {
    int           op;                   /* operations for the timer                   */
    plp_uint64_t  nanosecond;           /* low bits [63:00] of the nanosecond value   */
    plp_uint64_t  subnanosecond;        /* sub-nanosecond value                       */
    plp_uint64_t  hi_nanosecond;        /* high bits [127:64] of the nanosecond value */
...
/* 64-bit delay configuration data structure */
typedef struct bcm_plp_timesync_value_override_s {
    unsigned char  enable; /* Enable Flag  */
    plp_uint64_t   value;  /* 64 bit value */
} bcm_plp_timesync_value_override_t;
...
typedef struct bcm_plp_timesync_timespec_s {
    ...
    unsigned int       nanoseconds;   /* 30-bit Nanoseconds absolute value */
    plp_uint64_t       nanoseconds64; /* 64 bit Nanoseconds absolute value */
    bcm_plp_timesync_value_override_t syncref_delay; /**< Syncref delay configuration */
...
typedef struct bcm_plp_timesync_time_value_s {
    ...
    plp_uint64_t        time_value_hi;      /* Time value high(bit64-bit80) for 80-bit   */
    plp_uint64_t        dpll_time_value;    /* DPLL time value */
    plp_uint64_t        dpll_time_value_hi; /* DPLL time high(bit64-bit80) for 80-bit   */
...
#define BCMPLP_TIMESYNC_SOPMEM_CLASSIFIED_DATA_SIZE         8
#define BCMPLP_TIMESYNC_SOPMEM_TO_BE_READ_BYTE              0xFF

#define BCM_PLP_TIMESYNC_SOPMEM_SIZE 16
...
typedef struct bcm_plp_timesync_sopmem_s {
    ...
    unsigned char  src_ip[BCMPLP_TIMESYNC_SOPMEM_CLASSIFIED_DATA_SIZE];
                                   /* source IP address deprecated by classified_data *\
                                   \*        Left here for backward compatibility     */
    unsigned char  timestamp[10];  /* 10-octet timestamp       */
    unsigned char  classified_data[BCMPLP_TIMESYNC_SOPMEM_CLASSIFIED_DATA_SIZE];
                                   /* captured data classified by       *\
                                   |*   tx/rx_inband_prop.write_sopmem  *|
                                   \*   in  bcm_plp_timesync_config_t   */
    unsigned char  src_port_id[10]; /* 10-octet source port identity    */
    unsigned int   seq_id_encrypt;  /* Encrypted sequence ID            */
...
typedef struct bcm_plp_timesync_config_s {
    ...
    unsigned int flags;               /* Flags bcm_plp_timesync_flag_t */
    unsigned short itpid;             /* 1588 inner Vlan tag protocol identifier  */
    unsigned short otpid;             /* 1588 outer Vlan tag protocol identifier  */
    unsigned short otpid2;            /* 1588 outer Vlan tag protocol identifier2 */
    ...
    unsigned short otpid1;    /* 1588 Alternative outer Vlan tag protocol identifier (Egress) */
    unsigned short itpid_igr; /* 1588 Inner Vlan tag protocol identifier (Ingress) */
    unsigned short otpid_igr; /* 1588 Outer Vlan tag protocol identifier (Ingress) */
    unsigned short otpid1_igr;/* 1588 Alternative outer Vlan tag protocol identifier  (Ingress) */
    unsigned short otpid2_igr;/* 1588 Alternative outer Vlan tag protocol identifier2 (Ingress) */
    unsigned int   ip4udp_chksum_disable;      /* IPV4 UDP checksum disable */
    unsigned int   vxlan_outer_chksum_disable; /* PTP VxLan packet outer checksum disable */
    unsigned int   sopmem_intr_enable;         /* Enable port SOPMEM interrupt */
    unsigned int   sopmem_wr_on_err; /* Enable writing to SOPMEM when pkt_err or crc_err is received */
...
typedef enum bcm_plp_avs_control_e {
    ...
    bcmplpAvsControlExternal, /**< External Chip controls the AVS */
...
/*!
 * @enum bcm_plp_avs_track_status_e
 * @brief AVS track status type
 */
typedef enum bcm_plp_avs_track_status_e {
    bcmplpAvsTrackStatusNotStarted = 0, /**< AVS Not Started */
    bcmplpAvsTrackStatusNormal,         /**< AVS track normal */
    bcmplpAvsTrackStatusError           /**< AVS track Error */
} bcm_plp_avs_track_status_t;
...
typedef enum bcm_plp_avs_disable_type_e {
    ...
    bcmplpAvsDisableTypeFirmwareControl, /**< Firmware set back voltage */
...
/* Regulator channel configuration */
typedef enum bcm_plp_avs_regulator_channel_e {
    bcmplpAvsRegulatorChnlUnused = 0, /**< Regulator channel is not used for supplying DVDD to the chip */
    bcmplpAvsRegulatorChnlDVDDUsed    /**< Regulator channel used for supplying DVDD to the chip */
} bcm_plp_avs_regulator_channel_t;

/*! AVS regulator configuration structure for multiple regulators \n
  * \arg channel_info \n
  *  Output channel configuration\n
  * \arg regulator_addr  \n
  *   AVS regulator I2C address
  * \arg regulator_type \n
  *   AVS regulator type defined in bcm_plp_avs_regulator_t\n
 */
typedef struct bcm_plp_avs_regulator_config_s {
    bcm_plp_avs_regulator_channel_t channel_info[BCM_PLP_AVS_REGULATOR_CHANNELS_MAX];
    unsigned char regulator_addr;
    bcm_plp_avs_regulator_t regulator_type;
} bcm_plp_avs_regulator_config_t;
...
typedef struct bcm_plp_avs_config_status_s {
    ...
    bcm_plp_avs_track_status_t avs_track_status;
...
typedef struct bcm_plp_avs_config_s {
    ...
    unsigned char regulator_i2c_address;  /**< Set Regulator i2c slave address or DVDD rail address for multiple regulators, if not set, keep it 0 to use default regulator slave address*/
    ...
    bcm_plp_avs_regulator_config_t regulator_config[BCM_PLP_AVS_REGULATORS_MAX];   /**< Regulator Info structure only applicable for multiple regulators support */
...
typedef struct bcm_plp_ieee_pcs_rx_status_s {
    ...
    unsigned short ieee_bip_err_count_pcsln[BCM_PLP_PCS_ENCODED_BIT_STREAMS];      /*!< 3.200..3.219 - bip_error_counter @0..15 ; per pcs lane */
    unsigned short ieee_pcs_lane_mapping[BCM_PLP_PCS_ENCODED_BIT_STREAMS];         /*!< 3.400..3.419 - pcs_lane_mapping @0..4 ; per pcs lane */
...
typedef struct bcm_plp_pcs_rx_status_s {
    ...
    unsigned char pcs_skew_stat_pcsln[BCM_PLP_PCS_ENCODED_BIT_STREAMS];       /*!< per pcs lane ; valid from idx 0 till (pcsl_num - 1)*/
...
typedef enum bcm_plp_pattern_type_e {
    ...
    bcmplpPatternTypePCSScrambleIdle,   /**< PCS Scrambled IDLE pattern gen */
    bcmplpPatternTypeKP4PRBS,            /**< KP4 PRBS pattern */
    bcmplpPatternTypePCSScrambleIdleMon  /**< PCS Scrambled IDLE pattern monitor */
...
typedef struct bcm_plp_pai_fw_init_config_s {
    int phy_reverse_mode;         /* Configure normal or reverse mode to select line wrapper or serdes side */
    int macsec_static_bypass;     /* Configure MACSEC enable or bypass mode */
    int pll1_vco;                 /* Configure maximum VCO rate for PLL1 */
    int tx_drv_supply;            /* Configure TX driver support voltage */
    bcm_plp_pm_ref_clk_t ref_clk; /* Configure reference clock during firmware initialization */
    unsigned int phy_mode;        /* Select chip specific phy mode operation. See bcm_plp_phy_mode_sel_t for examples  */
...
typedef enum bcm_plp_mib_stat_type_e {
    ...
    BCM_PLP_MIB_STAT_RCRC               /* Receive CRC Error Counter*/
} bcm_plp_mib_stat_type_t;

/**
 * The enumeration for MIB stats operation.
 */
typedef enum bcm_plp_mib_stat_operation_e {
    BCM_PLP_MIB_STAT_OP_STATS_ENABLE = 0, /* Enable statistics if applicable */
    BCM_PLP_MIB_STAT_OP_STATS_DISABLE,    /* Disable statistics if applicable */
    BCM_PLP_MIB_STAT_OP_STATS_GET         /* Get statistics for the requested statistics type */
} bcm_plp_mib_stat_operation_t;

typedef struct bcm_plp_aperta_port_config_s {
    bcm_plp_aperta_fixed_latency_config_t    fixed_latency_config;
    int egr_ptp_fixed_latency; /*Applicable for Chip Rev B0*/
} bcm_plp_aperta_port_config_t;

/**
 * The enumeration for firmware upgrade stages.
 */
typedef enum bcm_plp_fw_upgrade_stage_e {
    bcmplpFwUpgradeStageGetDriverInfo = 0, /* Get driver information (Like active bank info)   */
    bcmplpFwUpgradeStageInit,              /* Init stage of firmware upgrade   */
    bcmplpFwUpgradeStageUpdate,            /* Update stage of firmware upgrade */
    bcmplpFwUpgradeStageFinish             /* Finish stage of firmware upgrade */
} bcm_plp_fw_upgrade_stage_t ;

/**
 * The enumeration for firmware upgrade type.
 */
typedef enum bcm_plp_fw_upgrade_type_e {
    bcmplpFwUpgradeTypeChip = 0,    /* Chip firmware upgrade      */
    bcmplpFwUpgradeTypeSrds,        /* Serdes firmware upgrade    */
    bcmplpFwUpgradeTypeEEPROM       /* Flash firmware into EEPROM */
} bcm_plp_fw_upgrade_type_t;

/**
 * The enumeration for hitless firmware upgrade side.
 */
typedef enum bcm_plp_fw_upgrade_side_e {
    bcmplpFwUpgradeSideDC,   /* Side dont care   */
    bcmplpFwUpgradeSideLine, /* Line side   */
    bcmplpFwUpgradeSideSys,  /* System side */
    bcmplpFwUpgradeSideBoth  /* Both side   */
} bcm_plp_fw_upgrade_side_t ;

/**
 * The structure for configuring firmware upgrade parameters externally
 */
typedef struct bcm_plp_fw_upgrade_params_s {
    unsigned char *img_addr   ; /* Image Buffer address provided by the application */
    unsigned int   img_len    ; /* Total size of the image */
    unsigned char  comp_type  ; /* Compression type        */
    unsigned short img_crc    ; /* Image CRC               */
    unsigned short img_param0 ; /* Image parameter 0       */
    unsigned short img_param1 ; /* Image parameter 1       */
    unsigned short page_num   ; /* Page number             */
    unsigned short page_size  ; /* Page size is the size of the buffer that application provides for a single transfer */
} bcm_plp_fw_upgrade_params_t;

/**
 * The structure for firmware upgrade configuration.
 */
typedef struct bcm_plp_fw_upgrade_config_s {
    bcm_plp_fw_upgrade_stage_t  stage  ; /* Hitless Firmware upgrade stage (init/update/finish) */
    bcm_plp_fw_upgrade_type_t   type   ; /* Hitless Firmware upgrade type (Chip/Serdes/EEPROM)  */
    bcm_plp_fw_upgrade_side_t   side   ; /* Serdes Firmware upgrade side(Line/System/Both)      */
    bcm_plp_fw_upgrade_params_t params ; /* Firmware upgrade parameters                         */
} bcm_plp_fw_upgrade_config_t;

/**
 * The structure for getting driver information like active bank.
 */
typedef struct bcm_plp_fw_upgrade_driver_info_s {
    unsigned int active_bank ;
} bcm_plp_fw_upgrade_driver_info_t;
