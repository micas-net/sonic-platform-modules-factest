...
int plp_aperta2_tscp_phy_interrupt_enable_set(const plp_aperta2_phymod_phy_access_t* phy, uint32_t intr_type, uint32_t enable);
int plp_aperta2_tscp_phy_interrupt_enable_get(const plp_aperta2_phymod_phy_access_t* phy, uint32_t intr_type, uint32_t* enable);
