 ...
 * -------------------------------------------------------------------------------- *
 * This sample application configures the Aperta2 chip for 100G FGB(4x25G_2x53G)    *
 * with macsec static bypass mode as follows:                                       *
 *   1. Connect to the board.                                                       *
 *   2. Download the firmware and initialize the PHY in static bypass mode          *
 *   3. Configure Tx/Rx polarity                                                    *
 *   4. Configure operating mode parameters for 100G FGB                            *
 *   5. Setup link training on System and Line side                                 *
 *   6. Test Traffic                                                                *
...
#define SYS_FEC_MODE            bcmplpaperta2RS528
