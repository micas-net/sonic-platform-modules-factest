 ...
 * -------------------------------------------------------------------------------- *
 * This sample application configures the Aperta2 chip for 25G (1x25G) NRZ with     *
 ...
 *   4. Configure operating mode parameters for 25G NRZ mode                        *
 *   5. Set/Get TxFir settings                                                      *
 *   6. Test Traffic                                                                *
...
int main(int argc, char *argv[])
{
    ...
    for (lane_map_index = 0; lane_map_index < total_lane_maps; lane_map_index++) {
        ...
        for(side = BCM_SYSTEM_SIDE; side >= BCM_LINE_SIDE; side--) {
            ...
            tx_fir.serdes_tx_tap_mode = TX_SET_NRZ_TAP_MODE;
            ...
            tx_fir.pre3  = TX_SET_NRZ_PRE3;
            tx_fir.pre2  = TX_SET_NRZ_PRE2;
            tx_fir.pre   = TX_SET_NRZ_PRE;
            tx_fir.main  = TX_SET_NRZ_MAIN;
            tx_fir.post  = TX_SET_NRZ_POST;
            tx_fir.post2 = TX_SET_NRZ_POST2;
            tx_fir.serdes_tx_tap_mode = TX_SET_NRZ_TAP_MODE;
