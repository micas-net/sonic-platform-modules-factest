...
from public.platform_common_config import BOARD_AIRFLOW_PATH, PRODUCT_NAME_PATH, SUB_VERSION_FILE, BOARD_ID_PATH
...
def getplatform_name_from_file():
    product_name = "NA"
...
def getplatform_name():
    ...
    return getplatform_name_from_file()
