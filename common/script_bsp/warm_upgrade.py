...
class RefreshUpgradeBase(object):
    ...
    def __init__(self, config, slot_num, devtype, subtype, file_type, chain):
        self._config = config
...
class RefreshUpgrade(RefreshUpgradeBase):
    ...
    def __init__(self, config, slot_num, devtype, subtype, file_type, chain):
        super(RefreshUpgrade, self).__init__(config, slot_num, devtype, subtype, file_type, chain)
    ...
    def do_warmupgrade(self, file, main_type, sub_type, slot, file_type, chain):
        try:
            ...
            for refresh_config in chain_list:
                ...
                refresh_instance = RefreshUpgrade(refresh_config, slot, main_type, sub_type, file_type, chain)
