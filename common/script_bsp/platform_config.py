...
platform_subver_configfile = (platform + "_" + board_id + "_" + sub_ver + "_config").replace("-", "_")  # platfrom + board_id + sub_ver
#bmc use _platform_config
platform_config_file_bmc = (platform + "_platform_config").replace("-","_")
