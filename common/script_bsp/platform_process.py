...
from platform_util import wbpciwr, set_value
from public.platform_common_config import platform_process_other_init, platform_process_other_init_pre
...
def startGenerate_mgmt_version():
    if STARTMODULE.get('generate_mgmt_version', 0) == 1: #default value 1 to generate
        for i in range(10):
