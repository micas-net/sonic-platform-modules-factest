...
import sys
import argparse
from platform_config import MANUINFO_CONF, MGMT_VERSION_PATH, BSP_COMMON_LOG_PATH
try:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Print firmware version.')
