                   ...
                   const char* buf, size_t count)
{
    ...
    if (ret < 0) {
        TEMP_SENSOR_ERR("set temp%u max threshold failed, value: %s, count: %zu, ret: %d\n",
            temp_index, buf, count, ret);
        return ret;
    }
    TEMP_SENSOR_DBG("set temp%u max threshold success, value: %s, count: %zu, ret: %d\n",
        temp_index, buf, count, ret);
    return count;
}
                   ...
                   const char* buf, size_t count)
{
    ...
    if (ret < 0) {
        TEMP_SENSOR_ERR("set temp%u min threshold failed, value: %s, count: %zu, ret: %d\n",
            temp_index, buf, count, ret);
        return ret;
    }
    TEMP_SENSOR_DBG("set temp%u min threshold success, value: %s, count: %zu, ret: %d\n",
        temp_index, buf, count, ret);
    return count;
}
                   ...
                   const char* buf, size_t count)
{
    ...
    if (ret < 0) {
        TEMP_SENSOR_ERR("set temp%u high threshold failed, value: %s, count: %zu, ret: %d\n",
            temp_index, buf, count, ret);
        return ret;
    }
    TEMP_SENSOR_DBG("set temp%u high threshold success, value: %s, count: %zu, ret: %d\n",
        temp_index, buf, count, ret);
    return count;
}
                   ...
                   const char* buf, size_t count)
{
    ...
    if (ret < 0) {
        TEMP_SENSOR_ERR("set temp%u low threshold failed, value: %s, count: %zu, ret: %d\n",
            temp_index, buf, count, ret);
        return ret;
    }
    TEMP_SENSOR_DBG("set temp%u low threshold success, value: %s, count: %zu, ret: %d\n",
        temp_index, buf, count, ret);
    return count;
}
