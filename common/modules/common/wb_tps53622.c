...
static pmbus_info_t tps53622_dfx_infos[] = {
...
static struct attribute *tps53622_attrs[] = {
...
static const struct attribute_group tps53622_sysfs_group = {
    .attrs = tps53622_attrs,
};
...
static int tps53679_probe(struct i2c_client *client)
{
    ...
    data->pmbus_info_array = tps53622_dfx_infos;
    data->pmbus_info_array_size = ARRAY_SIZE(tps53622_dfx_infos);

    ret = sysfs_create_group(&client->dev.kobj, &tps53622_sysfs_group);
    if (ret != 0) {
        dev_info(&client->dev, "Failed to create tps53622_sysfs_group, ret: %d.\n", ret);
...
static int tps53679_remove(struct i2c_client *client)
{
    sysfs_remove_group(&client->dev.kobj, &tps53622_sysfs_group);
