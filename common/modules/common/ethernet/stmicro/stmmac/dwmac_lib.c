...
void wb_stmmac_set_mac_addr(void __iomem *ioaddr, u8 addr[6],
...
EXPORT_SYMBOL_GPL(wb_stmmac_set_mac_addr);
...
void wb_stmmac_get_mac_addr(void __iomem *ioaddr, unsigned char *addr,
			 unsigned int high, unsigned int low)
{
...
EXPORT_SYMBOL_GPL(wb_stmmac_get_mac_addr);
