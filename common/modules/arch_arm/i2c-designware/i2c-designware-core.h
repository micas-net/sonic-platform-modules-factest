...
#define RESET_BY_IOADDR             0
#define RESET_BY_MEMADDR            1
#define RESET_BY_I2C_BUS            2
#define RESET_BY_GPIO               3
...
struct dw_i2c_dev {
	struct device		*dev;
	void __iomem		*base;
	void __iomem            *i2c_reset_reg;
	void __iomem            *mem_reg_base;
	u32                     mask_done;
	u32                     reg_i2c_status;				/* 9clk i2c status¼Ä´æÆ÷ */
	u32                     done_on;					/* 9clk doneÍê³É */
	u32                     i2c_busy;					/* 9clk busy bit */
	u32                     i2c_reset_mask;
	u32                     reset_src;
	u32                     reg_base;
	u32                     reset_gpio;
	...
	u32			abort_source;
	int			irq;
    u32         ctrl_idx;  /* real i2c controller index */
    u32         cpld_idx;  /* real cpld index for 9clk unlock */
	u32			flags;
