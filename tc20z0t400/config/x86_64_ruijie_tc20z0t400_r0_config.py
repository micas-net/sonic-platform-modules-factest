...
DRIVERLISTS = [
        ...
        {"name": "platform_common dfd_my_type=0x410d", "delay": 1},
    ...
    "slot0":{
        ...
        "TEST":{
            "fpga":[
                {
                    "chain": 1,
                    "file": "/etc/.upgrade_test/0x410d/fpga_test_header.bin",
                    "display_name": "FPGA",
                },
            ],
            "cpld":[
                {"chain":1, "file":"/etc/.upgrade_test/0x410d/base_cpld_test_header.vme", "display_name":"BASE_CPLD"},
                {"chain":2, "file":"/etc/.upgrade_test/0x410d/mac_cpld_test_header.vme", "display_name":"MAC_CPLD"},
                {"chain":3, "file":"/etc/.upgrade_test/0x410d/cpu_cpld_test_header.vme", "display_name":"CPU_CPLD"},
            ],
        },
    },
